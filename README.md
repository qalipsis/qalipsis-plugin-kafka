# <a src="https://qalipsis.io"><img src="http://assets.qalipsis.io/qalipsis-logo.png" style="height:60px;width:60px;position:relative;top:18px;margin-right:20px;"/>QALIPSIS for Apache Kafka</a>

![CI](https://github.com/qalipsis/qalipsis-plugin-kafka/actions/workflows/gradle-main.yml/badge.svg)

## Introduction

This repository contains the Apache Kafka plugin of QALIPSIS, an enterprise-grade load and performance-testing tool especially
...
The QALIPSIS plugin for Apache Kafka is distributed under the GNU Affero General Public License 3.0, the terms can be
read [here](./LICENSE).
