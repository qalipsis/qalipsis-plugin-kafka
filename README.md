...
![CI](https://github.com/qalipsis/qalipsis-plugin-kafka/actions/workflows/gradle-master.yml/badge.svg)
...
The QALIPSIS plugin for Apache Kafka is distributed under the Apache License 2.0, the terms can be
read [here](./LICENSE).
