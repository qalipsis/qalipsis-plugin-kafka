...
licenseReport {
    renderers = arrayOf<com.github.jk1.license.render.ReportRenderer>(
        com.github.jk1.license.render.InventoryHtmlReportRenderer(
            "report.html",
            "QALIPSIS plugin for Apache Kafka"
        )
    )
            ...
            publications {
                create<MavenPublication>("maven") {
                    ...
                    pom {
                        ...
                        scm {
                            connection.set("scm:git:https://github.com/qalipsis/qalipsis-plugin-kafka.git")
                            url.set("https://github.com/qalipsis/qalipsis-plugin-kafka.git/")
                        }
                    }
                }
            }
